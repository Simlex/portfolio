...
export const ALSO_BUILT: ProjectCardEntry[] = [
    {
        ...
        description:
            "A shopping app where factories post short videos of what they make and buyers order direct. It's live on iOS and Android. I bootstrapped the Expo app and the NestJS API, merged most of the team's pull requests and built the factory verification pipeline.",
        stack: ['Expo', 'React Native', 'NestJS', 'MongoDB', 'Cloudflare R2'],
        stats: ['100+ commits', '4 repos'],
        image: godofreda,
    ...
    },
    {
        ...
        description:
            'A two-sided booking app for stylists, barbers and makeup artists. I wrote about 92% of its commits in five months: bookings, a Paystack wallet, vendor KYC with selfies, real-time chat and push notifications.',
        stack: ['React Native', 'Expo', 'NativeWind', 'Socket.io', 'Paystack'],
        stats: ['600+ commits', '49 screens'],
        image: stylistPiazza,
